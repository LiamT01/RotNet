...
CUDA_VISIBLE_DEVICES=0,1,2,3 python train.py \
  ...
  --dataset_name protein_fragments --cutoff 4 --lr 0.001 --batch_size 128 --epochs 10000 \
...
#  --dataset_name protein_fragments --cutoff 4 --lr 0.001 --batch_size 256 --epochs 10000 \
#  --num_layers 5 --gaussian_num_steps 50 --x_size 92 --hidden_size 512 \
#  --use_invariance
